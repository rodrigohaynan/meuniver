...
export function PublicGiftExtras({
  ...
  if (!profile.length && !reservedGifts.length) return null;
        ...
        {reservedGifts.length > 0 && (
          <div>
            <div className="text-center">
              ...
              <p style={{ color: theme.colors.accent }} className="mt-3 text-xs font-bold uppercase tracking-[.16em]">
                Já escolhidos
              </p>
              <h2 className="mt-1 font-display text-2xl font-bold sm:text-3xl">Presentes que alguém já escolheu</h2>
              <p style={{ color: theme.colors.muted }} className="mx-auto mt-2 max-w-2xl text-sm leading-6">
                Eles continuam visíveis para ninguém achar que sumiram da lista, mas não podem ser reservados novamente.
              </p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      {gift.description && <p style={{ color: theme.colors.muted }} className="mt-2 text-sm leading-6">{gift.description}</p>}
                      {gift.price_hint && (
